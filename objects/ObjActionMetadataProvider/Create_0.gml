...
ParseValue = function(_config, _action_metadata_config, _value_key, _transform_function = function(_value) { return _value }) {
    var _value = _config[$ _value_key];
    if(!is_undefined(_value)) { _action_metadata_config[$ _value_key] = _transform_function(_value); }
}
